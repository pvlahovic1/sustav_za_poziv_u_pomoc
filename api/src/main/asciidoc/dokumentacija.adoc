...
==== CURL zahtjev
include::{snippets}/oranizacija/curl-request.adoc[]

==== httpie zahtjev
include::{snippets}/oranizacija/httpie-request.adoc[]

==== HTTP zahtjev
include::{snippets}/oranizacija/http-request.adoc[]

==== HTTP odgovor
Prikaz odgovora nakon uspješnog zahtjeva
include::{snippets}/oranizacija/http-response.adoc[]

Podaci koji se nalaze unutar tablice objašnjavaju podatke koji su dohvaćeni sa servisa nakon uspješnog dohvata podataka.
include::{snippets}/oranizacija/response-fields.adoc[]
