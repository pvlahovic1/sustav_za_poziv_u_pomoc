...
public class Organizacija_TipOrganizacije extends BaseModel{
    ...
    public Organizacija_TipOrganizacije() {
    }

    public Organizacija_TipOrganizacije(int idOrganizacija_TipOrganizacije, int idOrganizacije, int idTipOrganizacije, Organizacija organizacija, TipOrganizacije tipOrganizacije) {
